...
- main:
  ...
  - textbox "Email Address (for order tracking & receipt)": e2e_tester@auremont.com
  - text: Full Name
  - textbox "Full Name": Playwright Tester
  - text: Phone Number
  - textbox "Phone Number": "9876543210"
  - text: Address Line 1
  - textbox "Address Line 1": 123 Automation Lane
  - text: Address Line 2 (Apartment, suite, etc.)
  - textbox "Address Line 2 (Apartment, suite, etc.)"
  - text: City
  - textbox "City": Testing City
  - text: State / Province
  - textbox "State / Province": CA
  - text: Postal Code
  - textbox "Postal Code": "90210"
  - text: Country/Region
...
```ts
  ...
  62  |           body: JSON.stringify(MOCK_PRODUCT)
  63  |         });
  64  |       }
  65  |     );
  66  | 
