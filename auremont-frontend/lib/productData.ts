...
export const FALLBACK_PRODUCTS: Record<string, CatalogProduct> = {
  'california-reserve-raw': {
    ...
    weightGrams: 250,
    stockQty: 1000,
    thumbnailUrl: '/images/california-almonds-250g.webp',
  ...
  'roasted-sea-salt-almonds': {
    ...
    weightGrams: 500,
    stockQty: 500,
    thumbnailUrl: '/images/roasted-almonds-jar.webp',
    shortDescription: 'Masterfully roasted California almonds with fine sea salt in a thick UV-protected glass jar.',
    description: 'Masterfully roasted California almonds with fine sea salt in a thick UV-protected glass jar.',
    isFeatured: true,
    category: { name: 'Almonds', slug: 'almonds' },
    reviews: [
      {
  ...
  'royal-mangalore-jumbo-cashews-250g': {
    ...
    weightGrams: 250,
    stockQty: 800,
    thumbnailUrl: '/images/cashews-matte-black.webp',
  ...
  'black-truffle-roasted-cashews-500g': {
    ...
    weightGrams: 500,
    stockQty: 400,
    thumbnailUrl: '/images/truffle-cashews-matte-black.webp',
    shortDescription: 'Handcrafted slow-roasted king cashews dusted with Italian black winter truffle and Himalayan pink salt.',
    description: 'Handcrafted slow-roasted king cashews dusted with Italian black winter truffle and Himalayan pink salt.',
    isFeatured: true,
    category: { name: 'Cashews', slug: 'cashews' },
  },
  'imperial-iranian-akbari-pistachios-250g': {
    ...
    weightGrams: 250,
    stockQty: 600,
    thumbnailUrl: '/images/pistachios-matte-black.webp',
  ...
  'kashmiri-snow-white-walnut-halves-500g': {
    ...
    weightGrams: 500,
    stockQty: 450,
    thumbnailUrl: '/images/walnuts-matte-black.webp',
  ...
  'queensland-reserve-whole-macadamias-250g': {
    ...
    weightGrams: 250,
    stockQty: 300,
    thumbnailUrl: '/images/macadamias-matte-black.webp',
  ...
  'himalayan-wild-chilgoza-pine-nuts-200g': {
    ...
    weightGrams: 200,
    stockQty: 150,
    thumbnailUrl: '/images/pine-nuts-matte-black.webp',
    shortDescription: 'Hand-gathered wild Chilgoza pine nuts from high-altitude Himalayan pine forests. A rare Himalayan specialty harvest.',
    description: 'Hand-gathered wild Chilgoza pine nuts from high-altitude Himalayan pine forests. A rare Himalayan specialty harvest.',
    isFeatured: true,
  ...
  'royal-almonds-wooden-box': {
    ...
    weightGrams: 1000,
    stockQty: 100,
    thumbnailUrl: '/images/royal-almonds-wooden-box.webp',
  ...
  'window-pouch-almonds-250g': {
    ...
    weightGrams: 250,
    stockQty: 500,
    thumbnailUrl: '/images/almonds-pouch-window.webp',
  ...
  'grand-unboxing-luxury-box': {
    ...
    weightGrams: 1000,
    stockQty: 75,
    thumbnailUrl: '/images/luxury-gift-box-unboxing.webp',
    shortDescription: 'Hinged luxury gift box featuring curated California Almonds, Jumbo Cashews, Persian Pistachios, and Chilgoza with a gold gift card.',
    description: 'Hinged luxury gift box featuring curated California Almonds, Jumbo Cashews, Persian Pistachios, and Chilgoza with a gold gift card.',
    isFeatured: true,
    category: { name: 'Gift Sets', slug: 'gift' },
  },
};
