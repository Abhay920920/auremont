...
export const metadata: Metadata = {
  title: "Custom Luxury Gift Box Builder | RARE NUTS",
  description: "Create your personalized luxury almond gift set. Choose your mahogany box finish, premium almond flavors, personalized engraving, and custom wax seal.",
  alternates: {
    canonical: `${siteUrl}/custom-gift-box`,
  },
  openGraph: {
    title: "Custom Luxury Gift Box Builder | RARE NUTS",
    description: "Design an elegant gift set with handcrafted mahogany boxes and personalized engraving.",
  ...
  twitter: {
    ...
    title: "Custom Luxury Gift Box Builder | RARE NUTS",
    description: "Design an elegant gift set with handcrafted mahogany boxes.",
...
export default function CustomGiftBoxPage() {
  const breadcrumbItems = [
    { name: "Home", url: "/" },
    { name: "Shop", url: "/shop" },
    { name: "Custom Gift Builder", url: "/custom-gift-box" },
  ];
        ...
        <div className="site-container">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-8">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif text-primaryText tracking-tight">
              The Custom Gift Builder
            </h1>
            <p className="text-secondaryText text-base font-light leading-relaxed">
              Design an elegant gift set. Select your handcrafted wooden box, choose your favorite premium almonds, and add your personalized engraving.
            </p>
          </div>
        </div>
          ...
          <div className="bg-secondaryBg border border-luxuryGold/30 p-10 md:p-16 rounded-card flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="max-w-xl space-y-3">
              ...
              <p className="text-secondaryText text-sm font-light leading-relaxed">
                Our corporate gifting team offers custom company logo engraving, volume pricing, and multi-address delivery across India and worldwide.
              </p>
            </div>
