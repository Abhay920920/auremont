...
export default function Register() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-80px)] flex flex-col justify-center items-center px-4 sm:px-6 pt-28 pb-16 sm:pt-32 sm:pb-20 bg-background overflow-hidden">
      ...
      <div className="relative w-full max-w-[480px] bg-[#0A0A0C]/90 backdrop-blur-2xl border border-divider/80 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.95),0_0_35px_rgba(212,175,55,0.07)] p-8 sm:p-10 z-10 animate-fade-in">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full h-11 pl-9 pr-3 bg-[#0F0F12]/80 border border-divider text-sm text-primaryText placeholder-mutedText/40 focus:border-luxuryGold focus:bg-background/90 focus:ring-1 focus:ring-luxuryGold/30 focus:outline-none transition-all rounded-none"
                  required
                />
              </div>
            </div>
          ...
          <div className="pt-1">
            <label className="flex items-start gap-2 cursor-pointer select-none group">
              <input 
                ...
                className="w-3.5 h-3.5 mt-0.5 border border-divider rounded-none bg-background accent-luxuryGold cursor-pointer"
                required
              />
              <span className="text-[11px] text-secondaryText group-hover:text-primaryText leading-snug transition-colors">
                I agree to the{' '}
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full h-12 bg-gradient-to-r from-luxuryGold via-goldHover to-luxuryGold hover:opacity-95 text-background font-semibold uppercase tracking-[0.2em] text-xs shadow-[0_4px_20px_rgba(212,175,55,0.22)] hover:shadow-[0_6px_28px_rgba(212,175,55,0.38)] active:scale-[0.99] transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 mt-3 cursor-pointer"
          >
            {loading ? (
        ...
        <div className="text-center pt-5 mt-5 border-t border-divider/60">
          <p className="text-xs text-secondaryText">
            ...
            <Link href="/login" className="text-luxuryGold hover:text-goldHover font-medium underline underline-offset-4 transition-colors">
              Sign In
            </Link>
          </p>
        </div>
