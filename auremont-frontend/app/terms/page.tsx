      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-invert prose-gold max-w-none text-secondaryText space-y-8">
          ...
          <section>
            ...
            <p>By accessing or purchasing from rarenuts.com ("Site"), you agree to be bound by these Terms of Service. If you do not agree, please discontinue use of the Site immediately. These Terms apply to all visitors, customers, and registered users.</p>
          </section>

          <section>
            <h2 className="text-2xl font-serif text-luxuryGold mb-4">2. Products & Pricing</h2>
            <p>All prices are listed in USD. RARE NUTS reserves the right to modify prices at any time without prior notice. Product descriptions and imagery are for illustrative purposes only. We have made every effort to display colors and packaging as accurately as possible, but cannot guarantee exact color reproduction on all display devices.</p>
          </section>
          ...
          <section>
            ...
            <p>Payments are processed securely via Razorpay. RARE NUTS does not store or have access to your full credit card details.</p>
          </section>
